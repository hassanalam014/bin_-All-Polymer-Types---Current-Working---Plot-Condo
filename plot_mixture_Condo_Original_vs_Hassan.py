...
# zeta = 1.00369516 #+/- 7.6674e-04 (0.08%) (init = 1)
...
if Condo_Original:
	if T1!=0.0:
		result = calculateBinarySolubilitySwellingCondo_Original(P1,T1,Mp,Ms,zeta=czeta,Ppstar=Ppstar,Tpstar=Tpstar,Rpstar=Rpstar,Psstar=Psstar,Tsstar=Tsstar,Rsstar=Rsstar,verbose=True)
		Xs_T1_Condo_Original = result[2]
		Sw_T1_Condo_Original = result[3]
	if T2!=0.0:
		result = calculateBinarySolubilitySwellingCondo_Original(P2,T2,Mp,Ms,zeta=czeta,Ppstar=Ppstar,Tpstar=Tpstar,Rpstar=Rpstar,Psstar=Psstar,Tsstar=Tsstar,Rsstar=Rsstar,verbose=True)
		Xs_T2_Condo_Original = result[2]
		Sw_T2_Condo_Original = result[3]
	if T3!=0.0:
		result = calculateBinarySolubilitySwellingCondo_Original(P3,T3,Mp,Ms,zeta=czeta,Ppstar=Ppstar,Tpstar=Tpstar,Rpstar=Rpstar,Psstar=Psstar,Tsstar=Tsstar,Rsstar=Rsstar,verbose=True)
		Xs_T3_Condo_Original = result[2]
		Sw_T3_Condo_Original = result[3]
	if T4!=0.0:	
		result = calculateBinarySolubilitySwellingCondo_Original(P4,T4,Mp,Ms,zeta=czeta,Ppstar=Ppstar,Tpstar=Tpstar,Rpstar=Rpstar,Psstar=Psstar,Tsstar=Tsstar,Rsstar=Rsstar,verbose=True)
		Xs_T4_Condo_Original = result[2]	
		Sw_T4_Condo_Original = result[3]
	if T5!=0.0:	
		result = calculateBinarySolubilitySwellingCondo_Original(P5,T5,Mp,Ms,zeta=czeta,Ppstar=Ppstar,Tpstar=Tpstar,Rpstar=Rpstar,Psstar=Psstar,Tsstar=Tsstar,Rsstar=Rsstar,verbose=True)
		Xs_T5_Condo_Original = result[2]	
		Sw_T5_Condo_Original = result[3]
	if T6!=0.0:	
		result = calculateBinarySolubilitySwellingCondo_Original(P6,T6,Mp,Ms,zeta=czeta,Ppstar=Ppstar,Tpstar=Tpstar,Rpstar=Rpstar,Psstar=Psstar,Tsstar=Tsstar,Rsstar=Rsstar,verbose=True)
		Xs_T6_Condo_Original = result[2]	
		Sw_T6_Condo_Original = result[3]
	if T7!=0.0:	
		result = calculateBinarySolubilitySwellingCondo_Original(P7,T7,Mp,Ms,zeta=czeta,Ppstar=Ppstar,Tpstar=Tpstar,Rpstar=Rpstar,Psstar=Psstar,Tsstar=Tsstar,Rsstar=Rsstar,verbose=True)
		Xs_T7_Condo_Original = result[2]	
		Sw_T7_Condo_Original = result[3]
	if T8!=0.0:	
		result = calculateBinarySolubilitySwellingCondo_Original(P8,T8,Mp,Ms,zeta=czeta,Ppstar=Ppstar,Tpstar=Tpstar,Rpstar=Rpstar,Psstar=Psstar,Tsstar=Tsstar,Rsstar=Rsstar,verbose=True)
		Xs_T8_Condo_Original = result[2]	
		Sw_T8_Condo_Original = result[3]
	if T9!=0.0:	
		result = calculateBinarySolubilitySwellingCondo_Original(P9,T9,Mp,Ms,zeta=czeta,Ppstar=Ppstar,Tpstar=Tpstar,Rpstar=Rpstar,Psstar=Psstar,Tsstar=Tsstar,Rsstar=Rsstar,verbose=True)
		Xs_T9_Condo_Original = result[2]	
		Sw_T9_Condo_Original = result[3]
...
if Condo_Original:						
	if T1!=0.0:
		plt.plot(P1,Xs_T1_Condo_Original,'k',ls=ls1,label='Condo Original theory {} K'.format(T1),lw=linewidth)
	if T2!=0.0:
		plt.plot(P2,Xs_T2_Condo_Original,'k',ls=ls1,label='Condo Original theory {} K'.format(T2),lw=linewidth)
	if T3!=0.0:
		plt.plot(P3,Xs_T3_Condo_Original,'k',ls=ls2,label='{} K'.format(T3),lw=linewidth)
	if T4!=0.0:
		plt.plot(P4,Xs_T4_Condo_Original,'k',ls=ls3,label='{} K'.format(T4),lw=linewidth)
	if T5!=0.0:
		plt.plot(P5,Xs_T5_Condo_Original,'k',ls=ls5,label='{} K'.format(T5),lw=linewidth)
	if T6!=0.0:
		plt.plot(P6,Xs_T6_Condo_Original,'y',ls=ls3,label='{} K'.format(T6),lw=linewidth)
	if T7!=0.0:
		plt.plot(P7,Xs_T7_Condo_Original,'r',ls=ls3,label='{} K'.format(T7),lw=linewidth)
	if T8!=0.0:
		plt.plot(P8,Xs_T8_Condo_Original,'b',ls=ls3,label='{} K'.format(T8),lw=linewidth)
	if T9!=0.0:
		plt.plot(P9,Xs_T9_Condo_Original,'g',ls=ls3,label='{} K'.format(T9),lw=linewidth)
...
if Condo_Original:
	if T1!=0.0:
		plt.plot(P1,Sw_T1_Condo_Original,'k',ls=ls1,label='Condo Original theory {} K'.format(T1),lw=linewidth)
	if T2!=0.0:
		plt.plot(P2,Sw_T2_Condo_Original,'k',ls=ls2,label='{} K'.format(T2),lw=linewidth)
	if T3!=0.0:
		plt.plot(P3,Sw_T3_Condo_Original,'k',ls=ls3,label='{} K'.format(T3),lw=linewidth)
	if T4!=0.0:
		plt.plot(P4,Sw_T4_Condo_Original,'k',ls=ls4,label='{} K'.format(T4),lw=linewidth)
	if T5!=0.0:
		plt.plot(P5,Sw_T5_Condo_Original,'k',ls=ls5,label='{} K'.format(T5),lw=linewidth)
	if T6!=0.0:
		plt.plot(P6,Sw_T6_Condo_Original,'y',ls=ls3,label='{} K'.format(T6),lw=linewidth)
	if T7!=0.0:
		plt.plot(P7,Sw_T7_Condo_Original,'r',ls=ls3,label='{} K'.format(T7),lw=linewidth)
	if T8!=0.0:
		plt.plot(P8,Sw_T8_Condo_Original,'b',ls=ls3,label='{} K'.format(T8),lw=linewidth)
	if T9!=0.0:
		plt.plot(P9,Sw_T9_Condo_Original,'g',ls=ls3,label='{} K'.format(T9),lw=linewidth)
